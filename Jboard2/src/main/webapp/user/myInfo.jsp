			...
			if(isPassOk && confirm("정말 비밀번호를 수정하시겠습니까?")){
				...
				fetch('/Jboard2/user/myInfo.do', {
					...
					.then((data)=>{
						...
						if(data.result > 0){
							alert("비밀번호가 수정 되었습니다. 다시 로그인 하십시오.");
			...
			btnWithdraw.addEventListener("click", function(){
				...
				$.ajax({
					...
					success:function(data){
						console.log( "data : " + data);
						if(data.result > 0){
							alert("회원 탈퇴처리가 완료 되었습니다. 이용해 주셔서 감사합니다.");
        ...
        <main id="user">
            <section class="myInfo">
                <form action="/Jboard2/user/myInfo.do" method="post">
                	...
                	<input type="hidden" name="uid" value="${sessionScope.sessUser.uid}">
                    <table border="1">
