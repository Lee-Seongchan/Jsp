	...
	window.onload = function name() {
		...
		$.ajax({
			...
			success:function(data){
					...
					if(data.result > 0){
						$(".nickResult").css("color","red").text("이미 사용중인 휴대폰입니다.");
					}else{
						$(".nickResult").css("color","green").text("사용 가능한 휴대폰입니다.");
					}
				}
			})	
				...
				$.ajax({
					...
					success:function(data){
						...
						if(data.status > 0){
							...
							$(".resultEmail").css("color","red").text("인증코드 전송이 실패하였습니다. 잠시후 다시 시도하십시요")
						}
