	...
	<body>
		...
		<form action="/Ch06/user5/modifyProc.jsp" method="post">
			<table border = "1">
				...
				<tr>
					<td>성별</td>
					<td><input type="number" name="gender" value = "<%=vo.getGender()%>"></td>
				</tr>
				...
				<tr>
					<td>주소</td>
					<td><input type="text" name="address" value = "<%=vo.getAddr()%>"></td>
				</tr>
				...
				<tr>
					<td colspan="2" align="right"><input type="submit" type = "submit" value= "수정"></td>
				</tr>
			</table>
		</form>
	</body>
