<%@page import="kr.farmstory1.db.Utiles"%>
					...
					<form id="formCheck" action="./proc/deleteOrders.jsp" method="get">
	                    <table border="0">
	                        ...
	                        <tr>
	                            ...
	                            <td class="price"><%=Utiles.comma(order.getOrderPrice())%></td>
	                            <td class="count"><%=order.getOrderCount() %></td>
	                            <td class="delivery"><%=Utiles.comma(order.getOrderDelivery()) %></td>
	                            <td class="total"><%=Utiles.comma(order.getOrderTotal()) %></td>
