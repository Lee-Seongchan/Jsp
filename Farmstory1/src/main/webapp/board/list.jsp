...
<%
	...
	String group = request.getParameter("group"); //header.jsp에서 파라미터를 받은 value => croptalk event community 
	String cate  = request.getParameter("cate");   //header.jsp에서 파라미터를 받은 value => croptalk event community 
